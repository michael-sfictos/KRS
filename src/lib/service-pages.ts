...
export const accountingPage = {
  slug: "accounting", eyebrow: "Services / Accounting", title: "Accounting that keeps business in view.",
  description: "From formation to monthly books, financial insight and closure, KRS keeps the full accounting lifecycle connected.",
  ...
  featuresTitle: "Accounting should leave more time for the business.",
  features: [
    { title: "Books that stay current", description: "Documents, reconciliations, myDATA workflows and recurring obligations move through one dependable monthly process." },
    { title: "People who know your file", description: "Ask questions directly and receive practical guidance from KRS professionals who understand the context behind your numbers." },
    { title: "Information you can use", description: "See obligations, results and cash-flow signals early enough to support management decisions, not only historical reporting." },
  ],
  ...
  faqs: [
    ...
    { question: "Can KRS take over from our current accountant?", answer: "Yes. The switch starts with a file review and a dated responsibility plan, so active deadlines continue while records and working methods move to KRS." },
    ...
    { question: "Will we speak with real people?", answer: "Yes. You communicate directly with KRS professionals who know your file and can bring specialised accounting, tax, payroll or financial expertise into the conversation when needed." },
  ],
...
export const taxAdvisoryPage = {
  slug: "tax-advisory", eyebrow: "Services / Tax advisory", title: "Tax advice that makes the next decision clearer.", description: "KRS gives founders and leadership teams practical tax direction before a choice becomes a filing, exposure or missed opportunity.",
  heroImage: "/images/krs-tax-advisory-advisor.jpg", heroImageAlt: "KRS tax advisor discussing a business decision with a client", heroKicker: "Structure / VAT / planning / review", exploreLabel: "Explore tax advisory",
  featuresTitle: "Advice that connects the tax position to the business decision.", features: [
    { title: "A position before you act", description: "Bring entity, transaction, investment or owner questions to the right advisor before you commit to a path." },
    { title: "Context carried into the answer", description: "Your question arrives with the relevant business and accounting context, not as an isolated email thread." },
    { title: "Practical next actions", description: "Advice ends with a documented position, ownership and the next operational action." },
  ],
  ctaTitle: "Tax advice works best before the decision is difficult to unwind.", ctaDescription: "Tell us about the transaction, plan or pressure point. We will show you how KRS can structure the review.",
  benefitsTitle: "A more deliberate tax position across the year.", benefitsDescription: "KRS brings planning, compliance and decision support into one ongoing relationship with a visible evidence trail.", benefitsImage: "/images/krs-tax-advisory-os-snapshot.webp", benefitsImageAlt: "KRS tax advisory workspace showing a structured review",
  benefits: [
    { index: "01", title: "Tax planning", description: "Review choices around investments, distributions, growth and ownership before the relevant filing window closes." },
    { index: "02", title: "VAT and indirect tax", description: "Clarify VAT treatment, reporting obligations and supporting evidence for the way your business trades." },
    { index: "03", title: "Entity and owner questions", description: "Consider the tax implications of structure, compensation and changes in ownership." },
    { index: "04", title: "Audit readiness", description: "Keep working papers, explanations and the advisor review process organised when a question needs more scrutiny." },
  ],
  processTitle: "Bring a tax question to KRS in three clear steps.", processDescription: "A useful tax answer starts with the facts. KRS gathers the relevant context, confirms the review path and returns a practical position.", process: onboardingProcess,
  advisorImage: "/images/krs-expert-tax-advisor.webp", advisorImageAlt: "KRS tax advisory specialist", testimonialEyebrow: "Tax advisory perspectives", testimonialTitle: "What timely tax advice makes possible.",
  testimonials: [
    { quote: "Important choices now come with a conversation about the position before we move.", role: "Composite of common founder feedback" },
    { quote: "The answer was specific to our transaction and our file, which meant the team could act.", role: "Composite of common operator feedback" },
    { quote: "Having the work and reasoning in one place made the next review much simpler.", role: "Composite of common finance-team feedback" },
  ],
  faqTitle: "Tax questions worth bringing early.", faqDescription: "The first conversation helps us understand the decision, timing and records behind the question before we recommend a review path.",
  faqs: [
    { question: "What kinds of tax questions can KRS help with?", answer: "KRS can support questions about entity structure, VAT, investments, owner decisions, transactions, filings and audit readiness. We agree the right scope for the facts and timing involved." },
    { question: "Can you review a decision before we sign or pay?", answer: "Yes. It is usually best to involve an advisor before the commercial step is final, so the tax position, evidence and alternatives can be considered in time." },
    { question: "Do you work with our legal or finance team?", answer: "Yes. Where a decision needs legal, finance or specialist input, KRS can coordinate the tax review with the people already working on the matter." },
    { question: "Can KRS support an authority request?", answer: "Yes. We review the request, relevant periods and available records, then agree the responsibilities and response plan with you." },
  ],
  finalTitle: "Make tax a considered part of the decision.", finalDescription: "Bring KRS into the conversation early, with the people and evidence needed to reach a practical position.",
} as const satisfies ServicePageData;
